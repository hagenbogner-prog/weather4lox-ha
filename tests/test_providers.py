...
def test_cache_validity_cannot_exceed_forecast_horizon():
    options = {"forecast_days": 2, "openweathermap_cache_validity_hours": 168}
...
def test_refresh_is_clamped_to_30_minutes_to_24_hours():
    low = {"openweathermap_refresh_interval_minutes": 1}
    high = {"openweathermap_refresh_interval_minutes": 9999}
