...
> **Status:** Experimental / test version. The initial release is intended for diagnostics and compatibility testing before production use.
...
- Initial Weather4Lox/Loxone response generation
